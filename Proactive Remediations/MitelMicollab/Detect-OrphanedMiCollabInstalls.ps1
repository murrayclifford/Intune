<#
    .SYNOPSIS
    Searches registry for Mitel MiCollab installations that match the specified version
#>
...
foreach ($Path in $RegUninstallPaths){
        ...
        ForEach-Object {
            Write-Output "Non Compliant: Found MiCollab registry keys"
            Exit 1
    }
}

Write-Output "Compliant: MiCollab registry keys not found"
Exit 0
